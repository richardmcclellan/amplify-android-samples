...
public final class Post implements Model {
  ...
  public static final QueryField PUBLISH_DATE = field("publishDate");
  ...
  private final @ModelField(targetType="AWSDateTime") Temporal.DateTime publishDate;
  public String getId() {
      return id;
  }
  ...
  public Temporal.DateTime getPublishDate() {
      return publishDate;
  }
  
  private Post(String id, String title, Blog blog, Temporal.DateTime publishDate) {
    this.id = id;
    this.title = title;
    this.blog = blog;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), post.getId()) &&
              ...
              ObjectsCompat.equals(getPublishDate(), post.getPublishDate());
      }
  }
  ...
  @Override
   public String toString() {
    return new StringBuilder()
      ...
      .append("publishDate=" + String.valueOf(getPublishDate()))
      .append("}")
      .toString();
  }
  ...
  public interface BuildStep {
    ...
    BuildStep publishDate(Temporal.DateTime publishDate);
  }
  ...
  public static class Builder implements TitleStep, BuildStep {
    ...
    private Blog blog;
    private Temporal.DateTime publishDate;
    @Override
     public Post build() {
    ...
    @Override
     public BuildStep publishDate(Temporal.DateTime publishDate) {
        this.publishDate = publishDate;
        return this;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, Blog blog, Temporal.DateTime publishDate) {
      super.id(id);
      super.title(title)
        .blog(blog)
    ...
    @Override
     public CopyOfBuilder publishDate(Temporal.DateTime publishDate) {
      return (CopyOfBuilder) super.publishDate(publishDate);
    }
  }
